...
def make_CollisionObject(radius, n, angle=0, factor=1, axis=Vec2d(1,0)):
...
def main():
    ...
    objects.append(CollisionObject(Vec2d(-0.5,3), Vec2d(0,0), 1, make_CollisionObject(0.2,4,0,10), RED, 0, 1))
    objects.append(CollisionObject(Vec2d(1,0), Vec2d(0,0), 1, make_CollisionObject(0.3,7,0,3), BLUE, 0, -0.4))
    objects.append(CollisionObject(Vec2d(-1,0), Vec2d(0,0), 1, make_CollisionObject(1,3,0,0.5), GREEN, 0, 2))
